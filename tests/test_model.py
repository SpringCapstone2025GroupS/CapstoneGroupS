...
def test_validate_notam():
    ...
    expected_notam = Notam(
        ...
        number="A2157/24",
        type=NotamType.N,
        issued= datetime.fromisoformat("2024-10-02T19:54:00.000Z".replace("Z", "")),
        affectedFIR = "KZJX",
        selection_code="QCBLS",
        minimumFL="000",
        maximumFL="040",
        location="ZJX",
        effective_start=datetime.fromisoformat("2024-10-02T19:50:00.000Z".replace("Z", "")),
        effective_end=datetime.fromisoformat("2024-10-14T22:00:00.000Z".replace("Z", "")),
        text="ZJX AIRSPACE ADS-B, AUTO DEPENDENT SURVEILLANCE\nREBROADCAST (ADS-R), TFC INFO SER BCST (TIS-B), FLT INFO SER\nBCST (FIS-B) SER MAY NOT BE AVBL WI AN AREA DEFINED AS 49NM\nRADIUS OF 322403N0781209W.",
        classification=Classification.INTL,
        account_id="KZJX",
        last_updated=datetime.fromisoformat("2024-10-02T19:54:00.000Z".replace("Z", "")),
        icao_location = "KZJX",
        lower_limit="SFC",
        upper_limit="3999FT.",
    )
